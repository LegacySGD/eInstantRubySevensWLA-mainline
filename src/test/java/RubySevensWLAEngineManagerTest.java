...
public class RubySevensWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(RubySevensWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/RubySevensWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/RubySevensWLAIW/InitOutcome.xml").getDocumentElement();
